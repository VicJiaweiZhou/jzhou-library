...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :style="author.name === 'George Orwell' ? 'color: white; font-weight: bold;' : ''"
        >
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="([type, count], idx) in Object.entries(bookstores.storeTypes)" :key="idx">
          {{ type }} - {{ count }} stores
        </li>
      </ul>
...
const orwell = computed(() => {
  ...
  return authors.find((author) => author.name.includes("Orwell"));
})
